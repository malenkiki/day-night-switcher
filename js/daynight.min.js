...
function avoidFlash(currentChoice){var body=document.querySelector('body');if(currentChoice==='day'){body.style.backgroundColor='#eeeeee';}else{body.style.backgroundColor='#222222';}}
